...
- Generated (UTC): `2026-08-25T11:22:00.454514+00:00`
- Records: **128**
- Methods: `Base, GRPO-FourState, PESCO-Full, PESCO-Offline`
- Splits: `final_id, final_ood`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Base | 1.29 | 18.8% | 0.0% | 0.0% | 15.6% | NA | 50.0% | 1.09 |
| GRPO-FourState | 1.77 | 62.4% | 0.0% | 0.0% | 12.5% | NA | 68.8% | 1.417 |
| PESCO-Full | 2.521 | 90.8% | 40.6% | 21.9% | 0.0% | 0 | 96.9% | 2.071 |
| PESCO-Offline | 2.284 | 93.9% | 0.0% | 12.5% | 0.0% | NA | 81.2% | 1.689 |
...
See [strategy_metrics.png](strategy_metrics.png), [action_choice_heatmap.png](action_choice_heatmap.png), [cost_frontier.png](cost_frontier.png), [replication_fdr.png](replication_fdr.png), [compute_budget_breakdown.png](compute_budget_breakdown.png), [inference_budget_comparison.png](inference_budget_comparison.png), [belief_calibration.png](belief_calibration.png), [discovery_pass_at_k.png](discovery_pass_at_k.png), [preference_reversal.png](preference_reversal.png), [split_vrs_heatmap.png](split_vrs_heatmap.png) when the corresponding fields are present.
...
- [belief_calibration.png](belief_calibration.png)
- [belief_calibration.svg](belief_calibration.svg)
- [branch_trajectories.png](branch_trajectories.png)
- [branch_trajectories.svg](branch_trajectories.svg)
- [compute_budget_breakdown.png](compute_budget_breakdown.png)
- [compute_budget_breakdown.svg](compute_budget_breakdown.svg)
- [cost_frontier.png](cost_frontier.png)
- [cost_frontier.svg](cost_frontier.svg)
- [discovery_pass_at_k.png](discovery_pass_at_k.png)
- [discovery_pass_at_k.svg](discovery_pass_at_k.svg)
...
- [inference_budget_comparison.png](inference_budget_comparison.png)
- [inference_budget_comparison.svg](inference_budget_comparison.svg)
