...
def main(argv=None):
 ...
 result['oracle_branch_search']=oracle; result['method_matrix_contract']={'sft_shared_checkpoint':True,'rl_methods_share_atomic_reward':True,'oracle_excluded_from_training':True,'eval_splits':['tune','promotion'],'top1_gap_threshold':0.0}
