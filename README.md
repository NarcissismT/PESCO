...
- [P2.3 promotion-v2 collection](artifacts/tier1_p23_promotion_v2/p23_promotion_v2_collection.json) · [raw-evidence canonical reversal audit](artifacts/tier1_p23_promotion_v2/raw_canonical_audit.json) · [counterfactual leakage audit](artifacts/tier1_p23_promotion_v2/counterfactual_leakage_audit.json)
- [P2.3 raw-evidence 3-seed screening](artifacts/tier1_p23_screening_raw/p23_matrix_result.json) · [P2.3 oracle-state upper-bound screening](artifacts/tier1_p23_screening_oracle/p23_matrix_result.json) · [P2.3 frozen raw-evidence 10-seed matrix](artifacts/tier1_p23_frozen_raw_10seed/p23_matrix_result.json)
- [P2.3 strict shortcut probe (fail-closed)](artifacts/tier1_p23_shortcut_probe/shortcut_probe_result.json) · [fallback shortcut diagnostic](artifacts/tier1_p23_shortcut_probe_fallback/shortcut_probe_result.json) · [reward tie/stability audit](artifacts/tier1_p23_frozen_raw_10seed/reward_stability.json) · [P2.3 gate receipt](artifacts/tier1_p23_frozen_raw_10seed/p23_gate_receipt.json)
- [P2.3 experiment manifest](docs/p23_experiment_manifest.json)
